...
<form action="<?php echo Route::_('index.php?option=com_audiofile&view=audiofile&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div>
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', Text::_('COM_AUDIOFILES_AUDIOFILE_TAB_DETAILS')); ?>
		<div class="row">
			<div class="col-md-9">
				<div class="row">
					<div class="col-md-6">
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'picture', Text::_('COM_AUDIOFILES_AUDIOFILE_TAB_PICTURE')); ?>
		<div class="row">
			<div class="col-md-12">
